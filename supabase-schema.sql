...
insert into indicadores (isla, categoria, monitor, monitor_titulo, nombre, rotacion, orden) values
  ...
  -- Isla 4 · Completion (dividida en Wireline y Bundle de fractura)
  ('Isla 4','Completion',1,'TCO + Score de proveedores','TCO normalizado Wireline',false,20),
  ('Isla 4','Completion',1,'TCO + Score de proveedores','Score de proveedores Wireline',false,21),
  ('Isla 4','Completion',1,'TCO + Score de proveedores','Market Share asignado Wireline',false,22),
  ('Isla 4','Completion',2,'Concentración de Mercado — Oferta y Demanda','Concentración + HHI Wireline',false,23),
  ('Isla 4','Completion',2,'Concentración de Mercado — Oferta y Demanda','Cruce oferta–demanda Wireline',false,24),
  ('Isla 4','Completion',2,'Concentración de Mercado — Oferta y Demanda','Vencimientos Wireline',false,25),
  ('Isla 4','Completion',1,'TCO + Score de proveedores','TCO normalizado Bundle de fractura',false,41),
  ('Isla 4','Completion',1,'TCO + Score de proveedores','Score de proveedores Bundle de fractura',false,42),
  ('Isla 4','Completion',1,'TCO + Score de proveedores','Market Share asignado Bundle de fractura',false,43),
  ('Isla 4','Completion',2,'Concentración de Mercado — Oferta y Demanda','Concentración + HHI Bundle de fractura',false,44),
  ('Isla 4','Completion',2,'Concentración de Mercado — Oferta y Demanda','Cruce oferta–demanda Bundle de fractura',false,45),
  ('Isla 4','Completion',2,'Concentración de Mercado — Oferta y Demanda','Vencimientos Bundle de fractura',false,46),
  -- Isla 5 · OFS-30 (E-30)
